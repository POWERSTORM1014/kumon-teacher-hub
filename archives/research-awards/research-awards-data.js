// archives/research-awards/research-awards-data.js
// 연구대회 수상작 전용 큐레이션 데이터 — 자료 목록/목차. bookId는 항상 PDF 파일명(확장자 제외).
...
// {
//   file: 'kumon-research-awards-YYYY-example.pdf',       // pdf/ 폴더의 실제 파일명과 반드시 일치
//   subject: '연구대회 수상작',
//   stage: '2024',                        // 필터 드롭다운에 노출되는 값(연도)
//   range: '2024',
//   icon: '🏆',
//   category: 'textbook',                     // 'textbook'(본자료) | 'answer'(부속자료)
//   label: '제61회 전국 학습지도 연구대회 최우수상 - OOO',
