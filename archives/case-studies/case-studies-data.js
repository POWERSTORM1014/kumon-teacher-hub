// archives/case-studies/case-studies-data.js
// 현장 수업 사례 전용 큐레이션 데이터 — 자료 목록/목차. bookId는 항상 PDF 파일명(확장자 제외).
...
// {
//   file: 'kumon-case-studies-YYYY-example.pdf',       // pdf/ 폴더의 실제 파일명과 반드시 일치
//   subject: '현장 수업 사례',
//   stage: 'G단계',                        // 필터 드롭다운에 노출되는 값(단계)
//   range: 'G단계',
//   icon: '🏫',
//   category: 'textbook',                     // 'textbook'(본자료) | 'answer'(부속자료)
//   label: 'G단계 현장 수업 사례 - 학습 동기 부여',
