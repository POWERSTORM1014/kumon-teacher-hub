// archives/newsletter/newsletter-data.js
// 구몬피아 소식지 전용 큐레이션 데이터 — 자료 목록/목차. bookId는 항상 PDF 파일명(확장자 제외).
...
// {
//   file: 'kumon-newsletter-YYYY-example.pdf',       // pdf/ 폴더의 실제 파일명과 반드시 일치
//   subject: '구몬피아 소식지',
//   stage: '제102호',                        // 필터 드롭다운에 노출되는 값(발행호)
//   range: '제102호',
//   icon: '📰',
//   category: 'textbook',                     // 'textbook'(본자료) | 'answer'(부속자료)
//   label: '구몬피아 소식지 제102호',
