// archives/philosophy/philosophy-data.js
// 구몬 교육 원론 전용 큐레이션 데이터 — 자료 목록/목차. bookId는 항상 PDF 파일명(확장자 제외).
...
// {
//   file: 'kumon-philosophy-YYYY-example.pdf',       // pdf/ 폴더의 실제 파일명과 반드시 일치
//   subject: '구몬 교육 원론',
//   stage: '1편',                        // 필터 드롭다운에 노출되는 값(편)
//   range: '1편',
//   icon: '📜',
//   category: 'textbook',                     // 'textbook'(본자료) | 'answer'(부속자료)
//   label: '구몬식 교육 원론 - 자기주도학습',
