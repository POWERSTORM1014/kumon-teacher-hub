...
function buildPrecacheUrls() {
  const urls = ['/index.html', '/subjects.json', '/manifest.json', '/shared/annotation-engine.js', '/subjects/hanja/viewer.html', '/subjects/hanja/viewer.js', '/subjects/hanja/hanja-data.js'];
