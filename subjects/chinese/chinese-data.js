// subjects/chinese/chinese-data.js
// 중국어 전용 큐레이션 데이터 — 교재 목록/목차. bookId는 항상 PDF 파일명(확장자 제외).
...
// pdf/kumon-chinese-*.pdf를 인식해서 자료실 목록에 그대로 노출한다.
const MATERIALS = [
  { file: 'kumon-chinese-D-131-140.pdf', subject: '중국어', stage: 'D', range: 'D131~D140', icon: '🇨🇳', category: 'textbook', label: 'D단계 교재 (D131~D140)' },
];
